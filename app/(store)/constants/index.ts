...
// Bairros - SEM fallback. Somente dados do Supabase.
// Se nao houver bairros cadastrados, checkout mostra "Nenhum bairro disponivel"
export const FALLBACK_NEIGHBORHOOD_FEES: readonly { name: string; fee: number; active: boolean }[] = []
