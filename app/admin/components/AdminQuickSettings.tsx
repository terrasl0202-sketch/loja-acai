...
import { Zap, Store, Package, Image as ImageIcon, Clock, Truck, CreditCard, MessageCircle, Tag, Users2, Palette, LayoutGrid, LayoutDashboard, Shield, Gift } from "lucide-react"
...
const settingsItems = [
  ...
  { id: "premium" as TabType, icon: Gift, label: "Premium" },
